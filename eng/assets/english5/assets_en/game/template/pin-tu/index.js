var data = ['school', 'postoffice', 'hospital', 'park', 'cinema', 'science']
...
var record = document.getElementById('record') // 录音
var headset = document.getElementById('headset') // 耳机
var listItem7 = document.getElementsByClassName('list-item7')[0]
...
function start() {
  ...
  listItem7.classList.add('library-move')
  setTimeout(function() {
    record.play()
  }, 1500)
